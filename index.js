...
function moveDodgerLeft() {
   ...
   */
   const dodgerLeftEdge = positionToInteger(DODGER.style.left)
   if (dodgerLeftEdge > 0){
     if (dodgerLeftEdge < DODGERSPEED){
       DODGER.style.left = '0px'
     } else {
       DODGER.style.left = `${dodgerLeftEdge - DODGERSPEED}px`
     }
   }
}
...
function moveDodgerRight() {
   ...
   */
   ...
   if (dodgerRightEdge < 400){
     if (dodgerRightEdge > 400 - DODGERSPEED){
       DODGER.style.left = '360px'
     } else {
       DODGER.style.left = `${dodgerRightEdge - 40 + DODGERSPEED}px`
     }
   }
}
